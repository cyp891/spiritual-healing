const practitioners = [
  {
    ...
    bio: "With 12 years of experience, Lena specializes in chakra balancing and energy restoration.",
  ...
  },
  {
    id: 3,
    name: "Elena",
    specialty: "Yoga & Meditation Teacher",
    bio: "Elena creates personalized meditation practices for stress relief and inner peace.",
